\# 🛠️ Basic single phase induction Motor Start-Stop Control – Classic Control Circuit
...
!\[Circuit Simulation](Classic Control\_Task 16.gif)
...
!\[Circuit Diagram](Classic Control\_Task 16.png)
...
| `Control\_Task 16.esc` | The original EKTS simulation file                |

| `Control\_Task 16.gif`  | Animated simulation of the circuit in action     |

| `Control\_Task 16.png`  | Static image of the circuit layout               |
